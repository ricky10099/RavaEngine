...
void ExampleScene::Init() {
	...
	for (int i = 0; i < lightColors.size(); i++) {
		...
		m_pointLights[i] = CreateEntity<Rava::Entity>(name);
	...
	m_entity = CreateEntity<Rava::Entity>("Test");
	...
	m_testLight = CreateEntity<Rava::Entity>("testLight");
	...
	m_entity2 = CreateEntity<Rava::Entity>("Fish");
	...
	m_entity3 = CreateEntity<Rava::Entity>("Dragon");
